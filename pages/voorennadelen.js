...
import { Heading, Box, Divider, Center, Flex } from "@chakra-ui/react";
import {
  FaQuestionCircle,
  FaSistrix,
  FaCloudDownloadAlt,
          ...
          <Box className='bg-tekst'>
            <Box>
              <Heading className='h1'>
                <span className='line'></span> <span className='title'> V</span>
                oor- en nadelen
              </Heading>
            </Box>
            <Box className='nav'>
            ...
            <Box textAlign='left' w='100%'>
              ...
              <br />+ Leerlingen hebben veel controle over hun eigen leerproces.{" "}
              <br />+ Leerlingen zijn extra gemotiveerd omdat ze werken rond hun
              eigen interesses.
              <br />+ Leerlingen leren rekening te houden met hun groepsgenoten.
              <br />+ Leerlingen vertonen een grotere onafhankelijkheid en een
            ...
            <Flex mt='25px' textAlign='right' w='100%' ml='20%'>
              ...
              <br />- Group Investigation is een heel tijdrovende werkvorm. Het
              vraagt een goede voorbereiding van de leerkracht.
              <br />- Group Investigation verwacht een goed gekozen
              overkoepelend onderwerp, anders wordt het moeilijk.
              <br />- Leerkrachten durven niet altijd de verantwoordelijkheid
              bij de leerlingen te leggen. Dit moeten ze wel doen om het proces
              van GI te doen slagen.
              <br />- Niet alle studenten zijn al eerder blootgesteld aan de
              manier van werken van Group Investigation, wat een enorme
              aanpassing vraagt.
              <br />- Leerlingen vinden het moeilijk om hun meningen te delen
              met elkaar.
